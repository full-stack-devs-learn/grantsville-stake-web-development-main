...
5.	Sean's classes have all earned a cookie party. 
	...
	calculateCookiesNeeded(1, 5, 12) → 4
	calculateCookiesNeeded(2, 2) → 2

*/

// create your function here
function calculateCookiesNeeded(aStudents = 0, bStudents = 0, others = 0)
{
	// if (others == undefined) 
	// {
	// 	others = 0;
	...
	const aStudentCookies = aStudents * 4;
	const bStudentCookies = bStudents * 3;
	const otherCookies = others * 2;

	const totalCookies = aStudentCookies + bStudentCookies + otherCookies;

	const dozensOfCookies =  Math.ceil(totalCookies / 12);

	return dozensOfCookies;
